            ...
            <div class="row">
                <div class="col-md-7">
					<div class="text-slider border-deco <?php echo esc_attr($extraclass); ?>">
						...
						?>					   
							<div class="text-item">
								<h3><span class="id-color"><?php echo htmlspecialchars_decode($data['stitle']); ?></span></h3>
								<h2 class="style-4"><?php echo htmlspecialchars_decode($data['title']); ?><span class="id-color">.</span></h2>
							</div>  
						<?php } ?>
                    </div>
					<div class="spacer-double"></div>
