...
HTACCESS;
		    ...
		    if ( ! is_file( $cacheDir . 'logged-in/index.php' ) ) {
			    // /wp-content/cache/asset-cleanup/cache/(css|js)/logged-in/index.php
	...
	public function isWpacuLiteActive()
	{
		...
		if (is_file($wpAdminPluginFile)) {
			...
			if (in_array('wp-asset-clean-up/wpacu.php', apply_filters('active_plugins', get_option('active_plugins')))) {
				return true;
			}
		}
