...
class HardcodedAssets
{
			...
			foreach ($hardcodedMarkedForUnloadList as $hardCodedType => $hardcodedHandles) {
				foreach ($hardcodedHandles as $hardcodedHandle) {
					...
					if (in_array($hardCodedType, array('wpacu_hardcoded_links', 'wpacu_hardcoded_styles'))
						...
						if (isset($handlesInfo['styles'][$hardcodedHandle]['output_min']) && $handlesInfo['styles'][$hardcodedHandle]['output_min']) {
					...
					if (in_array($hardCodedType, array('wpacu_hardcoded_scripts_src', 'wpacu_hardcoded_scripts_inline'))
						...
						if (isset($handlesInfo['scripts'][$hardcodedHandle]['output_min']) && $handlesInfo['scripts'][$hardcodedHandle]['output_min']) {
	...
	public static function getHardcodedUnloadList()
	{
		...
		$hardcodedUnloadList['wpacu_hardcoded_links']          = isset($wp_object_cache->cache['wpacu_hardcoded_links'])          ? array_keys($wp_object_cache->cache['wpacu_hardcoded_links'])          : array();
		$hardcodedUnloadList['wpacu_hardcoded_styles']         = isset($wp_object_cache->cache['wpacu_hardcoded_styles'])         ? array_keys($wp_object_cache->cache['wpacu_hardcoded_styles'])         : array();
		$hardcodedUnloadList['wpacu_hardcoded_scripts_src']    = isset($wp_object_cache->cache['wpacu_hardcoded_scripts_src'])    ? array_keys($wp_object_cache->cache['wpacu_hardcoded_scripts_src'])    : array();
		$hardcodedUnloadList['wpacu_hardcoded_scripts_inline'] = isset($wp_object_cache->cache['wpacu_hardcoded_scripts_inline']) ? array_keys($wp_object_cache->cache['wpacu_hardcoded_scripts_inline']) : array();
